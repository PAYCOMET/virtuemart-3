...
jQuery().ready(function ($) {
    ...
    /* Events */
    /**********/
    $('#params_terminales').change(function () {
        switch ($(this).val()){
            case "0": // Seguro
                $(".terminales-param").parents('.control-group').hide();
                $("#params_tdfirst").val(1);
                break;
            case "1": // No Seguro
                $(".terminales-param").parents('.control-group').hide();
                $("#params_tdfirst").val(0);
                break;
            case "2": // Ambos
                $(".terminales-param").parents('.control-group').show();
                break;
        }
